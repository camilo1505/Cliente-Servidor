...
void multiplication(float *m1, float *m2, float *m3, int rowsM1, int colsM1, int rowsM2, int colsM2)
{
    for(int i=0; i<rowsM1; i++)
    {
        for(int j=0; j<colsM1; j++)
        {
            ...
            {
                m3[i*colsM1+j] += m1[i*colsM1+k] * m2[k*colsM1+j];
            }
        }
...
void strange(float *m1, float *m2, float *m3, int rowsM1, int colsM1, int rowsM2, int colsM2)
{
    for(int i=0; i<rowsM1; i++)
    {
        for(int j=0; j<colsM1; j++)
        {
            ...
            for(int k=0; k<colsM1; k++)
            {
                m3[i*colsM1+j] = std::min(m3[i*colsM1+j], m1[i*colsM1+k] + m2[k*colsM1+j]);
            }
        }
...
int main(int argc, char** argv)
{
    ...
    if((rowsM1 == colsM2))
    {
        ...
        strange(m1,m2,m3,rowsM1, colsM1, rowsM2, colsM2);      
    }
    else
    {
